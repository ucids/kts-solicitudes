<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if ($resultado_solicitud->num_rows > 0) {
            ...
            $departamento = $solicitud['fk_departamento'];
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row gx-10 mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-5">
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="Proveedor" name="proveedor" id="proveedor"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <label
                                                class="required form-label fs-6 fw-bolder text-gray-700 mb-3">Servicio</label>
                                            <div class="mb-5">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea name="notas" class="form-control form-control-solid" rows="3"
                                            placeholder="<? echo $place_notes; ?>" required><?php echo $solicitud['notas']; ?></textarea>
                                    </div>
                                    <!--end::Notes-->
                                </div>
                                <!--end::Wrapper-->
                        ...
                        <div class="card-body p-10">
                            <div class="mb-10">
                                <div class="fw-bolder d-flex align-items-center fs-5">
                                    ...
                                    <span
                                        class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"><?php echo $user['departamento']; ?></span>
                                    ...
                                    <input type="hidden" name="departamento" value="<?php echo $solicitud['fk_departamento']?>">
                            ...
                            <!-- <div class="mb-8">
                                <label
                                    ...
                                    <input class="form-check-input" type="checkbox" name="urgente" value="0" 
                                    <?php
