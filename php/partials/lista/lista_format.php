<?php
    ...
    $sql = "SELECT solicitudes.*, users.nombre, users.apellidos, users.email, departamento.departamento AS nombre_departamento
        ...
        WHERE solicitudes.status = " . $estatus . $queryCondition;
    ...
    $query_solicitudes = "SELECT COUNT(*) AS total_solicitudes FROM solicitudes WHERE status = 0; ";
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    <span class="badge badge-light-<? echo $status_class ?> me-auto"><?echo $status_value ?></span>
                                </div>
                                <!--end::Status-->
                                <!--begin::Description-->
                            ...
                            <div class="d-flex mb-4">
                                <a href="solicitud.php?tipo=op" class="btn btn-sm btn-bg-light btn-active-color-primary me-3">Nueva Solicitud OP</a>
                                <a href="solicitud.php?tipo=tj" class="btn btn-sm btn-primary me-3">Nueva Solicitud TJ</a>
