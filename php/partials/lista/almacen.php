<?php
    ...
    WHERE solicitudes.fk_departamento IN ($scope) AND solicitudes.status = " . $estatus . $queryCondition;
                                                    ...
                                                    foreach ($result as $key => $value) {
                                                        if (is_numeric($key)) {
                                                            ...
                                                            if ($resultado_supervisor->num_rows > 0) {
                                                                ...
                                                                $supervisor = "Pendiente de Aprobación";
                                                            }
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <a href="invoice.php?id=<? echo $result[$key]['id']; ?>&almacen=<? echo $result[$key]['status']?>"
