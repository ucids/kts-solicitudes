        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-6" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                    ...
                    <?php if (!in_array($user['fk_rol'], [1,2,3])) { ?>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="solicitud.php?tipo=op">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Nueva Solicitud OP</span>
                            </a>
                        </div>
                        <div class="menu-item">
                    ...
                    <?}elseif (in_array($user['fk_rol'], [2])) {?>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link" href="solicitud.php?tipo=servicios">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Registro Servicios</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link active" href="lista.php?solicitud?tipo=servicio">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="lista.php?estatus=0">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Solicitudes Nuevas</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link active" href="lista.php?estatus=1">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Solicitudes Pendientes</span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="lista.php?user=solicitante">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
