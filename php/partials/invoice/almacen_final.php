...
if (isset($_GET['id'])) {
    ...
    if ($resultado_solicitud->num_rows > 0) {
        ...
        $query_articulos = "SELECT * FROM articulos WHERE solicitud_id = '$solicitud_id' AND cerrado = 'TRUE'";
																...
																<table class="table">
																	<thead>
																		<tr class="border-bottom fs-6 fw-bolder text-muted text-uppercase">
																			...
																			<th class="min-w-100px w-110px pb-9 text-end">Cantidad Solicitada</th>
																			<th class="min-w-100px w-100px text-center">Cantidad Recibida</th>
																		</tr>
																	</thead>
																	<tbody>
																		...
																		<tr class="fw-bolder text-gray-700 fs-5 text-end">
																			...
																			<td class="pt-5	">
																				<input class="form-control form-control-solid" type="number" min="1" name="cantidad_recibida[<?echo $i ?>]" 
																				placeholder="<? echo $articulo['cantidad_recibida'] ?>" value="<? echo $articulo['cantidad_recibida']?>" 
												...
												<div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
													...
													<div class="m-0">
														...
														<br>
															...
															<?}else{?>
																<a href="index.php" class="btn btn-primary"><i class="fas fa-envelope-open-text fs-4 me-2"></i> Regresar</a>	
															<? }?>
