									...
									<div class="d-flex flex-column flex-xl-row">
										...
										<div class="m-0">
											...
											<div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
												...
												<? if($user['fk_rol']==3){ ?>
												<div class="mb-6">
													<div class="fw-bold text-gray-600 fs-7">Aprobado por:</div>
													<div class="fw-bolder text-gray-800 fs-6"><? echo $supervisor['nombre'] . ' ' .$supervisor['apellidos']; ?></div>
												</div>
												<? } ?>
												<div class="mb-6">
												...
												<div class="m-0">
													...
													<br>
														<div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center">	
															<? if ($user['fk_rol'] == 5 && $status != 7) { ?>
																<a href="index.php" class="btn btn-sm btn-primary">Regresar</a>
																	<span class="bullet bullet-dot bg-primary mx-2"></span></span>
															<?	}elseif($user['fk_rol']== 5 && $status == 7){ ?>
																<a href="functions/invoice/action.php?submit=aprove&solicitud=
																	<?echo $solicitud_id?>" class="btn btn-sm btn-success">Aceptar</a>
																	<span class="bullet bullet-dot bg-success mx-2"></span></span>
																	<a href="index.php" class="btn btn-sm btn-danger">Rechazar</a>
															...
															<? }else{ ?>
																<? if ($rol == 4 && $status == 0){ ?>
																<a href="functions/invoice/action.php?submit=aprove&id=
																	<?echo $solicitud_id?>&user=<? echo $user_id ?>&puesto=supervisor" class="btn btn-sm btn-success">Aprobar</a>
																<span class="bullet bullet-dot bg-success mx-2"></span></span>
																<a href="functions/invoice/action.php?submit=deny&id=<?echo $solicitud_id ?>&user=<? echo $user_id ?>&puesto=supervisor"" class="btn btn-sm btn-danger">Rechazar</a>
																<span class="fs-7 text-danger d-flex align-items-center">
																<span class="bullet bullet-dot bg-danger mx-2"></span></span>
																<a href="solicitud.php?tipo=<?echo $solicitud['tipo']?>&id=<?echo $solicitud_id?>" class="btn btn-sm btn-primary">Editar</a>
																	<span class="bullet bullet-dot bg-primary mx-2"></span></span>								
																<? }elseif($rol == 4 && $status != 0){ ?>
																	<a href="lista.php" class="btn btn-sm btn-primary">Regresar</a>
																	<span class="bullet bullet-dot bg-primary mx-2"></span></span>
																<? } ?>
															<? } ?>
														</div>
